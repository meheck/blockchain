    ...
    def is_chain_valid (self,chain):
        ...
        while block_index < len(chain):
            ...
            if self.hash(previous_block) != block['previous_hash']:
                return False
            previous_proof= block['previous_hash']
...
#creating a web app for user to mine blockchain on a userfriendly interface
app= Flask(__name__)
...
def mineblock ():
    ...
    response= {'message':'You have successfully mined a block, congratulations!',
    'index':block['index'], 'timestamp':block['timestamp'], 'previous_hash':block['previous_hash'],
    'proof':block['proof']}
